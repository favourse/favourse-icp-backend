...
import { idlFactory } from './hai_event.did.js';
export { idlFactory } from './hai_event.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HAI_EVENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hai_event.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hai_event canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hai_event.did.js")._SERVICE>}
 */
export const hai_event = createActor(canisterId);
