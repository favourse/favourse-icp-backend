...
import { idlFactory } from './favourse_swipe_event.did.js';
export { idlFactory } from './favourse_swipe_event.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FAVOURSE_SWIPE_EVENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./favourse_swipe_event.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the favourse_swipe_event canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./favourse_swipe_event.did.js")._SERVICE>}
 */
export const favourse_swipe_event = createActor(canisterId);
