...
import { idlFactory } from './cuycuy.did.js';
export { idlFactory } from './cuycuy.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CUYCUY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cuycuy.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cuycuy canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cuycuy.did.js")._SERVICE>}
 */
export const cuycuy = createActor(canisterId);
