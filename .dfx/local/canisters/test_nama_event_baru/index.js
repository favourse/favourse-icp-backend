...
import { idlFactory } from './test_nama_event_baru.did.js';
export { idlFactory } from './test_nama_event_baru.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TEST_NAMA_EVENT_BARU_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./test_nama_event_baru.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the test_nama_event_baru canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./test_nama_event_baru.did.js")._SERVICE>}
 */
export const test_nama_event_baru = createActor(canisterId);
