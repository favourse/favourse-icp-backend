...
import { idlFactory } from './testcanister.did.js';
export { idlFactory } from './testcanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TESTCANISTER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./testcanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the testcanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./testcanister.did.js")._SERVICE>}
 */
export const testcanister = createActor(canisterId);
