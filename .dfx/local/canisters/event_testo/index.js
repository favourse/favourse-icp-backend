...
import { idlFactory } from './event_testo.did.js';
export { idlFactory } from './event_testo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.EVENT_TESTO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./event_testo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the event_testo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./event_testo.did.js")._SERVICE>}
 */
export const event_testo = createActor(canisterId);
