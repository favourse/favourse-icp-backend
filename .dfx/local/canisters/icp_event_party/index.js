...
import { idlFactory } from './icp_event_party.did.js';
export { idlFactory } from './icp_event_party.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP_EVENT_PARTY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_event_party.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_event_party canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_event_party.did.js")._SERVICE>}
 */
export const icp_event_party = createActor(canisterId);
