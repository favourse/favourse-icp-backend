...
import { idlFactory } from './lololo.did.js';
export { idlFactory } from './lololo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOLOLO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lololo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lololo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lololo.did.js")._SERVICE>}
 */
export const lololo = createActor(canisterId);
