...
import { idlFactory } from './haihai.did.js';
export { idlFactory } from './haihai.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HAIHAI_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./haihai.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the haihai canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./haihai.did.js")._SERVICE>}
 */
export const haihai = createActor(canisterId);
