...
import { idlFactory } from './gede_event.did.js';
export { idlFactory } from './gede_event.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GEDE_EVENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./gede_event.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the gede_event canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./gede_event.did.js")._SERVICE>}
 */
export const gede_event = createActor(canisterId);
