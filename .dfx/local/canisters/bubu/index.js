...
import { idlFactory } from './bubu.did.js';
export { idlFactory } from './bubu.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.BUBU_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bubu.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bubu canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bubu.did.js")._SERVICE>}
 */
export const bubu = createActor(canisterId);
