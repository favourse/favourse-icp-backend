...
import { idlFactory } from './favourse_test_event.did.js';
export { idlFactory } from './favourse_test_event.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FAVOURSE_TEST_EVENT_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./favourse_test_event.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the favourse_test_event canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./favourse_test_event.did.js")._SERVICE>}
 */
export const favourse_test_event = createActor(canisterId);
