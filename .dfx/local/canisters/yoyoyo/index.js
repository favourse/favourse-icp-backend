...
import { idlFactory } from './yoyoyo.did.js';
export { idlFactory } from './yoyoyo.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.YOYOYO_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./yoyoyo.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the yoyoyo canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./yoyoyo.did.js")._SERVICE>}
 */
export const yoyoyo = createActor(canisterId);
