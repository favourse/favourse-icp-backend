...
import { idlFactory } from './jeje.did.js';
export { idlFactory } from './jeje.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.JEJE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./jeje.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the jeje canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./jeje.did.js")._SERVICE>}
 */
export const jeje = createActor(canisterId);
