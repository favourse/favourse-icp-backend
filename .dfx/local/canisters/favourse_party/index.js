...
import { idlFactory } from './favourse_party.did.js';
export { idlFactory } from './favourse_party.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FAVOURSE_PARTY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./favourse_party.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the favourse_party canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./favourse_party.did.js")._SERVICE>}
 */
export const favourse_party = createActor(canisterId);
