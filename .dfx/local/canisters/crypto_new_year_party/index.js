...
import { idlFactory } from './crypto_new_year_party.did.js';
export { idlFactory } from './crypto_new_year_party.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CRYPTO_NEW_YEAR_PARTY_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./crypto_new_year_party.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the crypto_new_year_party canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./crypto_new_year_party.did.js")._SERVICE>}
 */
export const crypto_new_year_party = createActor(canisterId);
